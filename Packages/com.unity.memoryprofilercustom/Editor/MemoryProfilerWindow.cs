...
namespace Unity.MemoryProfiler.Editor
{
    internal class MemoryProfilerWindow : EditorWindow
    {
        ...
        internal SnapshotDataService m_SnapshotDataService;
        internal PlayerConnectionService m_PlayerConnectionService;

        internal MemoryProfilerViewController m_ProfilerViewController;
